...
export default function ExperienciasAprendizagem() {

  //constante dos inputs
  const promptFormat = 'Me sugira vários recursos de aprendizagem(por exemplo: livros, vídeos, podcasts, exercícios interativos) que atendam a diferentes estilos de aprendizagem com o segunte tema ou habilidade:';
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Criar Experiências de Aprendizagem</h1>
            <p>Ideias para criar experiências de aprendizagem</p>
