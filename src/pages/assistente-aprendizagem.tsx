...
export default function AssistenteAprendizagem() {

  //constante dos inputs
  const [qutItens, setQutItens] = useState('');
  const [cursoTema, setCursoTema] = useState('');
  const promptFormat = `Quero que você atue como um designer de e-learning e sugira algumas práticas recomendadas 
  para projetar módulos de e-learning eficazes para ${cursoTema} que sejam envolventes e interativos para ${qutItens}`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Assistente de Aprendizagem</h1>
            <p>Crie um design de e-learning baseado em um tópico e público alvo</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o tópico?" value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />

                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o público alvo?" value={qutItens} onChange={(e) => setQutItens(e.target.value)} />
