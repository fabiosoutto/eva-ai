...
export default function PerguntasDesafiadoras() {

  //constante dos inputs
  const [cursoTema, setCursoTema] = useState('');
  const promptFormat = `Forneça-me uma série de perguntas desafiadoras ou problemas relacionados a ${cursoTema}
    para testar minha compreensão e melhorar a retenção do aprendizado de longo prazo`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Perguntas Desafiadoras</h1>
            <p>Crie uma série de perguntas desafiadoras ou problemas relacionados a um tópico ou habilidade para testar sua compreensão e melhorar a retenção do aprendizado</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] md:w-full p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o tópico ou habilidade?" value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />
