...
export default function PlanoEstudos() {
  ...
  const promptFormat = `Projete um cronograma semanal de repetição espaçada de pequenos momentos de estudo,
  para que eu revise efetivamente sobre ${cursoTema} ao longo do tempo, proporcionando melhor retenção e memorização`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Criar um Plano de Estudos</h1>
            <p>Ideias para criar um planos de estudos, com temáticas mais indicadas e um escopo mais interessante</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] md:w-full p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o tema do curso ou habilidade?" value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />
