...
export default function Onboarding() {
  ...
  const promptFormat = `Crie treinamento de boas vindas para novos colaboradores com estes valores:
   setor da empresa: ${input1}, ramo da empresa: ${input2}, tempo de duração do treinamento: ${input3} 
   e retorne o treinamento completo para ser apresentado aos novos colaboradores`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Onboarding</h1>
            <p>Ideias para criar treinamentos de boas vindas que acolham novos colaboradores</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Os colaboradores são de qual área?" value={input1} onChange={(e) => setInput1(e.target.value)} />
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual a duração do treinamento?" value={input2} onChange={(e) => setInput2(e.target.value)} />
              </div>

              <div className="flex flex-wrap gap-3 mt-[15px]">
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Sua empresa é de qual ramo?" value={input3} onChange={(e) => setInput3(e.target.value)} />
              </div>
