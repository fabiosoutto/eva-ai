...
export default function Metricas() {
  ...
  const promptFormat = `Como posso desenvolver objetivos de aprendizagem claros e mensuráveis para o seguinte tópico ${cursoTema}`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Métricas para Temas Específicos</h1>
            <p>Desenvolver objetivos de aprendizagem claros e mensuráveis para um determinado tópico</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] md:w-full p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o tópico desejado?" value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />
