...
export default function IndicacoesConteudos() {
  ...
  const promptFormat = 'Quais são os vídeos curtos, inspiradores e didáticos para aprender mais sobre o seguinte tema:';
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Indicações de Conteúdos</h1>
            <p>Ideias de indicações de vídeos curtos, inspiradores e didáticos para aprender mais</p>
