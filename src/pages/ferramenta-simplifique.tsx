...
export default function FerramentaSimplifique() {

  //constante dos inputs
  const [cursoTema, setCursoTema] = useState('');
  const promptFormat = `Reescreva a seguinte frase para ficar mais fácil de entender: ${cursoTema}`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Ferramenta Simplifique</h1>
            <p>Reescreva uma frase para ficar mais fácil de entender</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] md:w-full p-3 bg-transparent border rounded outline-none" type="text" placeholder="Digite a sua frase..." value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />
