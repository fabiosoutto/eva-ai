...
export default function PlanosAprendizagem() {

  //constante dos inputs
  const [cursoTema, setCursoTema] = useState('');
  const promptFormat = `Quero que você identifique os 20% do tópico sobre ${cursoTema} que vão trazer 80% dos
  resultados desejados e me providencie um plano de aprendizado focado para dominar esse tópico`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Planos de Aprendizagem</h1>
            <p>Desenvolva um plano de aprendizagem</p>
