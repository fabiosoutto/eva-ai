...
export default function ListaAtividades() {
  ...
  const promptFormat = `Desenvolva objetivos de aprendizado claros e mensuráveis para ${cursoTema} que se alinhem com o público alvo da área de ${qutItens}`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Objetivos e Resultados</h1>
            <p>Desenvolva objetivos de aprendizado claros e mensuráveis para um tópico que se alinhem com o público alvo de uma determinada área</p>
