...
export default function ListaAtividades() {
  ...
  const promptFormat = `Crie uma lista de potenciais atividades de aprendizagem sobre o seguinte tema ou curso com a quantidade de itens na lista em ${qutItens}:`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Lista de Atividades</h1>
            <p>Crie uma lista de potenciais atividades de aprendizagem para um determinado curso ou tópico</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o curso ou tópico?" value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />

                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Quantidade de itens da lista" value={qutItens} onChange={(e) => setQutItens(e.target.value)} />
