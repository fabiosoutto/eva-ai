...
export default function Storytelling() {
  ...
  const promptFormat = `Transforme os principais conceitos sobre ${cursoTema} em histórias, casos reais ou narrativas
  envolventes para me ajudar a lembrar e entender melhor o conteúdo`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Storytelling para Aprendizagem</h1>
            <p>Ferramenta para criar histórias envolventes que ensinam sobre determinado assunto</p>
