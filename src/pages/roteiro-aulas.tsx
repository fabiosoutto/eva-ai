...
export default function RoteiroAulas() {
  ...
  const promptFormat = `Crie um roteiro para aulas com estes valores
   ${cursoTema}, ${cursoObjetivo}, ${cursoPublico}, ${cursoDuracao}`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Roteiro para Aulas</h1>
            <p>Ideias para criar roteiros de aulas que engajam</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o tema da aula?" value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o objetivo da aula?" value={cursoObjetivo} onChange={(e) => setCursoObjetivo(e.target.value)} />
              </div>
              ...
              <div className="flex flex-wrap gap-3 mt-[15px]">
                  ...
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o tempo de duração da aula?" value={cursoDuracao} onChange={(e) => setCursoDuracao(e.target.value)} />
              </div>
