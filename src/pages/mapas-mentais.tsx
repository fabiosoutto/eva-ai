...
export default function MapasMentais() {
  ...
  const promptFormat = `Desenvolva um mapa mental para um programa de ${cursoTema} sobre ${qutItens}`;
      ...
      <section>
        ...
        <div className={`
          ...
          <div className="gap-1 p-5 mr-5 w-[900px]">
            <h1 className="font-extrabold text-[25px]">Mapas Mentais</h1>
            <p>Desenvolva um mapa mental para um programa de treinamento</p>
            ...
            <form action="" onSubmit={handleSubmit}>
              <div className="flex flex-wrap gap-3">
                  ...
                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o tipo de treinamento?" value={cursoTema} onChange={(e) => setCursoTema(e.target.value)} />

                  <input className="w-[320px] p-3 bg-transparent border rounded outline-none" type="text" placeholder="Qual o assunto?" value={qutItens} onChange={(e) => setQutItens(e.target.value)} />
